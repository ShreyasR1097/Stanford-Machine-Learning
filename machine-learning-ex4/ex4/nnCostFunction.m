...
for i=1:theta1size(1,1)
    for j=1:theta1size(1,2)
        if j ~= 1
            theta1sum = theta1sum + Theta1(i,j)^2;
        end
    end
end
...
for i=1:theta2size(1,1)
    for j=1:theta2size(1,2)
        if j ~= 1
            theta2sum = theta2sum + Theta2(i,j)^2;
        end
    end
end
